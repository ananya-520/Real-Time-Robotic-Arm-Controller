...
public class MotionPlanner extends Thread {
	...
	public void run() {
		while (true) {
			...
			System.out.println(MotorController.getTimeStamp() + ": [EXECUTION] Motion Planner requesting resource");
			...
			System.out.println(MotorController.getTimeStamp() + ": [EXECUTION] Motion Planner Computation Finished");
		}
	}
