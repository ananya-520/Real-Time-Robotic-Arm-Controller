...
public class MotorController {
    ...
    */
	...
	public synchronized void accessController(String threadName) {
		
		System.out.println(getTimeStamp() + ": [LOCK ACQUIRED] " + threadName + " has acquired the MotorController resource");
		...
		System.out.println(getTimeStamp() + ": [LOCK RELEASED] " + threadName + " has released the MotorController resource");
	}
